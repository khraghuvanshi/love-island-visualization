...
const Home: NextPage = () => {
  ...
  return (
    <div className="bg-[#c2e5f2] h-full">
      <Head>
        <title>Love Island Visualizations</title>
        <meta name="description" content="Love Island USA Season 7 Data Visualizations" />
      ...
      <main >
        ...
        /> */}
        <h1 className="text-center text-5xl font-bold pt-8 text-red-500">Love Island USA</h1>
